...
- [x] Role `base` — provisioning système
- [x] Role `services` — déploiement des apps
- [x] Role `caddy` — reverse proxy unifié
- [x] Réseau Docker `proxy` partagé
- [x] Secrets dans Ansible Vault
- [ ] Role `backup` — migration du script cron vers Ansible
